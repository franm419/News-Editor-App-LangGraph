...
async def ask_question(
    ...
    # Pasamos la pregunta del usuario como "article" al workflow
    response_state = await human_workflow.ainvoke(
        input={"article": request.question},
    ...
    thread.answer = response_state.get("answer", "No se pudo generar respuesta")
